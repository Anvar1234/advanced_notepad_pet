...
public abstract class AbstractNote {
    ...
    protected AbstractNote(NoteBuilder<?> noteBuilder) {
        this.id = noteBuilder.id;
        this.title = noteBuilder.name;
        this.createdDateTime = noteBuilder.createdDateTime;
        this.changedDateTime = noteBuilder.changedDateTime;
        this.remainderDate = noteBuilder.remainderDate;
        this.isPinned = noteBuilder.isPinned;
        this.priority = noteBuilder.priority;
        this.tags = noteBuilder.tags;
        this.status = noteBuilder.status;
    ...
    // Абстрактный Builder
    public abstract static class NoteBuilder<T extends NoteBuilder<T>> {
        ...
        public T changedDateTime(LocalDateTime changedDateTime) {
            this.changedDateTime = changedDateTime;
            return self();
        }

        public T remainderDate(LocalDateTime remainderDate) {
            this.remainderDate = remainderDate;
            return self();
        }

        public T isPinned(boolean isPinned) {
            this.isPinned = isPinned;
            return self();
        }

        public T priority(NotePriorityEnum priority) {
        ...
        public T status(NoteStatusEnum status) {
            this.status = status;
            return self();
        }
